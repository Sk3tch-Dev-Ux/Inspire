    ...
    <html lang="en" className={`${dmSans.variable} ${spaceGrotesk.variable}`}>
      ...
      <body className="min-h-screen bg-midnight antialiased">
        <AuthProvider>
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-electric focus:text-midnight focus:rounded-lg focus:font-semibold focus:text-sm"
          >
